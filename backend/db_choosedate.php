...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO booking (user_id, date, time, place, nama_cadangan1, ic_cadangan1, phone_cadangan1, email_cadangan1, nama_cadangan2, ic_cadangan2, phone_cadangan2, email_cadangan2, status_code, masjid_id) 
                                VALUES (:user_id, :date, :time, :place, :nama_cadangan1, :ic_cadangan1, :phone_cadangan1, :email_cadangan1, :nama_cadangan2, :ic_cadangan2, :phone_cadangan2, :email_cadangan2, :status_code, :masjid_id)");
